        ...
        composable(route = Halaman.Mahasiswa.name) {
            MahasiswaFormView(
                onSubmitButtonClicked = { listDataMhs ->
                    mahasiswaViewModel.saveDataMahasiswa(Mahasiswa(nim = listDataMhs[0], nama = listDataMhs[1], email = listDataMhs[2]))
        ...
        composable(route = Halaman.Matakuliah.name) {
            RencanaStudyView(
                ...
                onSubmitButtonClicked = { listData ->
                    krsViewModel.saveDataKRS(RencanaStudi(mataKuliah = listData[0], kelas = listData[1]))
